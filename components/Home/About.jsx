    ...
    id='About'>
     ...
     viewport={{once: true}}
      ...
      <motion.p
       ...
       whileInView={{opacity: 1, y:0}}
       viewport={{once: true}}
      className='text-gray-500 max-w-80 text-center mb-8'>Passionate About Technology, Dedicated to your Vision</motion.p>
      <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
        ...
        whileInView={{opacity: 1, x:0}}
        viewport={{once: true}}
        className='flexflex-col items-center md:items-start text-gray-600'>
